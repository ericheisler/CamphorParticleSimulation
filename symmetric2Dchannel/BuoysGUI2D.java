 ...
 * @author Heisler
 */
class BuoysGUI2D implements ActionListener{
	...
	public void actionPerformed(ActionEvent e){
		if (e.getSource() == runButton){
			...
			if(!worker.getState().equals(SwingWorker.StateValue.STARTED)){
				...
				writeImage(boatsPanel.image, "images/N"+String.valueOf(model.N)+"vis"+String.valueOf((int)(10000*pars[3]))+"K"+String.valueOf((int)pars[7])+"T"+String.valueOf((int)model.getTime())+".bmp");
			}
...
//////////////////////////////////////////////////////////////////////////
	...
	class BPanel extends JPanel {
		...
		public void paintComponent(Graphics g) {
			...
			ig.drawString("camphor concentration, threshold = "+String.format("%.4f",1/dims[9]), 20, experiment.getHeight()+picposy+10);
	...
	class PPanel extends JPanel {
        ...
        JLabel NLabel, RLabel, WLabel, mLabel, visLabel, LLabel, rcLabel, DLabel, kLabel, aLabel, bLabel, csatLabel, dgLabel, restLabel;
        public JTextField NField, RField, WField, mField, visField, LField, rcField, DField, kField, aField, bField, csatField, dgField, restField;
		...
		public PPanel() {
			...
			csatField = new JTextField(String.valueOf(params[10]), 6);
            csatField.setEditable(true);
			dgField = new JTextField(String.valueOf(params[11]), 6);
            dgField.setEditable(true);
			restField = new JTextField(String.valueOf(params[12]), 6);
		...
		public void newParameters(){
			try{
				...
				params[10] = Double.valueOf(csatField.getText());
				params[11] = Double.valueOf(dgField.getText());
				params[12] = Double.valueOf(restField.getText());
